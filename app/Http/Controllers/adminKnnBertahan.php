...
class adminKnnBertahan extends Controller
{
    function viewFormBertahan() {
        return view('admin.prediksiBertahan', [
            "title" => "Prediksi Admin Bertahan"
        ]);
    }

    function bertahanKnnAdmin(Request $request) {
