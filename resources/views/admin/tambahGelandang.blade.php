...
@section('konten')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Form Tambah Data Pemain Gelandang</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                    <li class="breadcrumb-item">Tambah Data</li>
                    <li class="breadcrumb-item active">Gelandang</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
