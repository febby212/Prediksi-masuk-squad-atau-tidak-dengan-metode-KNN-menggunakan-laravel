...
@section('konten')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Form Prediksi Pemain Gk</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Prediksi Gk</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Multi Columns Form -->
                    <form class="row g-3" action="/adminPrediksiGk" method="POST">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <input type="hidden" name="posisi" value="gk">
