        ...
        <section id="faq" class="faq">
            <div class="container">
                ...
                <div class="section-title">
                    {{-- <h2>How to Use</h2> --}}
                    <h3>Silahkan masukkan data pemain <b>Bertahan</b> yang akan diprediksi</h3>
                ...
                <div>
                    <form action="{{ route('predict.bek') }}" method="POST" class="row g-3">
                        @csrf
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control border border-2" id="inputAddress"
                                placeholder="Contoh: Harry Maguire" name="nama">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="hidden" id="inputZip" name="posisi" value="bek">
