    ...
    <main id="main">
        ...
        <section id="faq" class="faq">
            <div class="container">
                ...
                <div class="section-title">
                    {{-- <h2>How to Use</h2> --}}
                    <h3>Silahkan masukkan data pemain <b>Gelandang</b> yang akan diprediksi</h3>
                ...
                <div>
                    <form action="{{ route('predict.tengah') }}" method="POST" class="row g-3">
                        @csrf
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control border border-2" id="inputAddress"
                                placeholder="Contoh: Declan Rice" name="nama">
                        </div>
                        ...
                        <input type="hidden" id="inputZip" name="posisi" value="tengah">
        ...
        <section id="features" class="features section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Kriteria Data</h2>
                    <p>Pemain Tengah atau Gelandang</p>
                </div>
