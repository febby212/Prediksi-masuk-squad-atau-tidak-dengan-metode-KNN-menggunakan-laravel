            ...
            <div class="row">
                <div class="col-sm-6 login-section-wrapper">
                    ...
                    <div class="login-wrapper my-auto">
                        ...
                        <form action="/daftar" method="post" class="row g-3">
                            @csrf
                            <div class="form-group">
                                <label for="name">Nama Lengkap</label>
                                <input type="name" name="name" id="name"
                                    class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Deoun Dune">
                                @error('name')
                        ...
                        <a href="/login" class="forgot-password-link">Already Have account? Sign in here</a>
                        <a href="/" class="forgot-password-link"> Or Home</a>
                    </div>
                </div>
                <div class="col-sm-6 px-0 d-none d-sm-block">
                    <img src="asetLogin/images/squad1.jpg" alt="login image" class="login-img">
                </div>
            </div>
        </div>
    </main>
